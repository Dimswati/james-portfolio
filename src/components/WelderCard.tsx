  ...
  return (
    <div className='p-5 pb-8 shadow-md rounded-md'>
              ...
              <div className="flex flex-col items-center mt-12 gap-y-8">
                <button className='bg-transparent border px-8 py-2 rounded-full text-neutral-900 text-lg font-semibold hover:from-rose-900 hover:to-neutral-900 transition duration-300 border-green-800 w-full'><a href="https://wa.me/+254111338700" target='_blank' className='flex gap-x-4 items-center justify-center'><BsWhatsapp/>whatsapp</a></button>
