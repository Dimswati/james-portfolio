  ...
  return (
    <main className="bg-neutral-50 font-rubik">
      ...
      <section className="pb-24">
        ...
        <div className="container lg:max-w-[75vw] py-20">
          ...
          <div className="flex gap-x-16 mb-24">
            <div className="relative w-96 h-80 basis-1/2"><Image src='http://a.ourhtmldemo.com/decorators/wp-content/uploads/2016/11/service-image-1.jpg' alt="" className="object-cover origin-center rounded-md" fill={true}/></div>
      ...
      <section className="pb-20">
        ...
        <div className="container mb-20">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-x-4 items-center">
              <button className="text-neutral-800 text-xl p-4 border border-neutral-800 rounded-full"><BsChevronLeft/></button>
              <button className="text-neutral-800 text-xl p-4 border border-neutral-800 rounded-full"><BsChevronRight/></button>
            </div>
          </div>
        </div>
        <div className="container mb-20">
        ...
        <div className="my-24">
          <h3 className="text-xl font-bold mb-16 text-center">From small exiting projects</h3>
        ...
        <div className="container my-24">
          <h3 className="text-xl font-bold mb-20 text-center">To Large Contracts</h3>
          <div className="lg:max-w-[75vw] mx-auto">
            <div className="flex gap-x-16 overflow-x-hidden mb-24 items-center">
              <div>
            ...
            <div className="flex gap-x-16 overflow-x-hidden items-center">
              <div>
                <div className="relative h-80 w-96">
                  <Image src='http://a.ourhtmldemo.com/decorators/wp-content/uploads/2016/11/service-image-1.jpg' alt="" className="object-cover origin-center rounded-lg" fill={true}/>
                </div> 
        ...
        <div className="container flex flex-col items-center">
          <h4 className="text-xl text-neutral-800 text-center font-inria-serif font-bold mb-8">I do them all with my youthful enthusiasm and ultimate customer satisfaction</h4>
          <button className="medium-btn-gradient w-fit mb-12">call me now</button>
          <p className="text-neutral-500 text-sm">Customer reviews coming here soon</p>
        </div>
      </section>
      <section className="bg-gradient-to-b from-neutral-900 to-rose-900 pt-24 pb-16">
        <div className="container">
          ...
          <div className="lg:max-w-[60vw] mx-auto">
            <div className="flex gap-x-12 items-center my-16">
